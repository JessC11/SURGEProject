insert into customer (email, passwordHash, firstName, lastName)
...
insert into programme (programme)
...
insert into journey (flightId, tripId)
values (1, 1),
(2, 3),
(3, 5),
(4, 7),
